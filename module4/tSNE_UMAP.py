...
# Create data with four clusters in a 3D space
centers = [ [ 2, -6, -6],
            [-1,  9,  4],
            [-8,  7,  2],
            [ 4,  7,  9] ]
...
Distancias globales relativamente consistentes.

Contras:

Puede exagerar la separación entre grupos solapados.

Tiende a uniformar densidades y no respeta proporciones reales.

Puede colocar puntos en “clusters incorrectos”.
'''
...
'''
Su capacidad de preservar la conectividad topológica (a diferencia de t-SNE).

Su fidelidad en representar distancias y solapamientos reales.

Aunque tiene problemas parecidos a t-SNE (puntos mal colocados, densidades homogéneas),
en general mantiene mejor la estructura global de los datos.
'''
...
'''
en algunos casos —como este experimento— PCA, a pesar de ser más simple, puede ofrecer mejores 
resultados tanto en rendimiento como en fidelidad estructural.
'''
