...
## Cluster Stability
'''
To evaluate the stability of clustering, running k-means multiple 
times with different initial centroids by not fixing the random state 
helps determine if the algorithm consistently produces similar cluster 
assignments and inertia scores. Consistent inertia across runs suggests 
a stable solution that is less dependent on initial centroid positions.
'''
...
## Performance variance the number of clusters
...
# Exercise3: Plot the blobs and the clustering results for k = 3, 4, and 5
...
'''
We will use make_classification to create a labelled 2-d dataset of three clases
'''
