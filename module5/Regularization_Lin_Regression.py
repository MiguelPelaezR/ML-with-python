...
# Generate a synthetic dataset with one feature
noise=1
np.random.seed(42)
...
### Fit Ordinary, Ridge, and Lasso regression ###
...
## Create a high dimensional dataset using make_regression
...
print(regression_results(y_test, y_pred_linear, 'Ordinary'))
...
## Part 1. Choose a threshold value to select features
...
'''
Lasso identifica qué variables son importantes (basado en si sus coeficientes son suficientemente grandes).

Se entrena de nuevo con solo esas variables importantes.

Se comparan tres enfoques distintos de regresión usando ese subconjunto reducido de datos.
'''


### Recreated the same plots as before to compare the data
